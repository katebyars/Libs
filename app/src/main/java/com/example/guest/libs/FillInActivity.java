...
public class FillInActivity extends AppCompatActivity {
    ...
    @Bind(R.id.createStoryButton) Button mCreateStoryButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCreateStoryButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String object1 = mObject1.getText().toString();
                String object2 = mObject2.getText().toString();
                String adjective1 = mAdjective1.getText().toString();
                String actionword1 = mActionword1.getText().toString();
                String largeflatobject = mLargeflatobject.getText().toString();
                String kindofdwelling = mKindofdwelling.getText().toString();
                String bodypart = mBodypart.getText().toString();
                String occupation = mOccupation.getText().toString();
                String food1 = mFood1.getText().toString();
                String food2 = mFood2.getText().toString();
